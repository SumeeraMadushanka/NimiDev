...
const Contact = () => {
  return (
    <div className=" bg-bg-contact bg-cover">
      <div className="antialiased  p-10  " id="contact">
              ...
              <div className="flex flex-col space-y-6">
                ...
                <div className="inline-flex space-x-2 items-center">
                  <ion-icon
                    ...
                    className="text-teal-300 text-xl"
                  ></ion-icon>
                  <span>computerswinmac@gmail.com</span>
                </div>
                <div className="inline-flex space-x-2 items-center">
                  <ion-icon
                    name="location"
                    className="text-teal-300 text-xl"
                  ></ion-icon>
                  <span>N0:123, Main Street, Colombo.</span>
                </div>
              </div>
